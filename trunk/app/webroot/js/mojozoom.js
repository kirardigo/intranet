		...
		addEvent(zoomImg, "load", function() {
				...
				addEvent(zoomInput, "mouseout", 
					function(e) {
						...
						if (relTarget != target) {
							...
							//BN: added to support multiple images in the same zoom container
			...
			addEvent(zoomInput, "mousemove", 
				function(e) {
					...
					//BN - made this work with scroll offsets in FF
					if (!isIE)
					{
						var offset = Element.extend(img).cumulativeScrollOffset();
						pos.x += offset.left;
						pos.y += offset.top;
					}
					//BN end 
